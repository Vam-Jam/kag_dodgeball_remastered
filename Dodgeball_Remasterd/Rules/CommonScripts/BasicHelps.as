...
void onInit(CRules@ this)
{
	...
	AddIconToken("$Balld", "Entites/Specials/BallD/Ball.png", Vec2f(8, 8), 0);
	AddIconToken("$Ballg", "Entites/Specials/Ballg/Ballg.png", Vec2f(8, 8), 0);
	AddIconToken("$Balle", "Entites/Specials/Balle/Balle.png", Vec2f(13, 13), 0);
	AddIconToken("$Ballb", "Entites/Specials/Balle/Ballb.png", Vec2f(10, 12), 0);
