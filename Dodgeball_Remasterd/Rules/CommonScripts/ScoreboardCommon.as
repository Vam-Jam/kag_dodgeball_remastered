...
SColor getNameColour(CPlayer@ p)
{
    ...
    } else if (username == "Vamist") { //to add other users do (username == "Vamist") || (username == "Vamist2") and so on.
        c = SColor(250, 102, 225, 225);//vamists blue color, change vamist to your name terra. Remeber it goes alpha, red, green, blue.
    } else if (p.isGuard()) {
        c = SColor(0xffb400ff); //guard
